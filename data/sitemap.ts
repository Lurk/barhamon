...
export const How_to_serve_sitemap_xml_with_Next_JS: PostInterface = {
  ...
  preview: [p("To not only increase entropy but also be useful, this blog should be indexed by search engines.")],
  full: [
    p("To not only increase entropy but also be useful, this blog should be indexed by search engines. And to make it easier for search engines to index, they came up with robots.txt and sitemap."),
    createMessage({
      content: [
        p([
    ...
    p("For our site to produce sitemap.xml, create a sitemap.xml.tsx file in the pages folder:"),
