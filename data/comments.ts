...
const preview = p("In this post, you will learn how to add comments to your Next.js project. And it is easy with Disqus.");
...
export const comments: PostInterface = {
  ...
  full: [
    ...
    p([
      "Third, install the ",
      a({ url: "https://www.npmjs.com/package/disqus-react", text: "disqus-react" }),
    ...
    p([
      ...
      a({ url: "https://github.com/Lurk/barhamon/blob/master/components/comments.tsx", text: "comments.tsx" })
    ])
  ],
};
