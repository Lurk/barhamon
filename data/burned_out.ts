...
export const burned_out: PostInterface = {
  ...
  time: 1604828490367,
  image:
    "https://res.cloudinary.com/barhamon/image/upload/c_scale,q_auto,w_600/v1609664954/header/burned_out_iwicib.jpg",
  tags: ["personal"],
  description: "Story of me burned out",
  preview: [
    p("For five years, I've been working as a system architect in a startup."),
  ],
  full: [
    p(
    ...
    p([
      ...
      a({
        url: "/post/[pid]",
        as: "/post/the_fun_stuff",
        text: "that will be another post",
      }),
      ").",
    ]),
    p(
