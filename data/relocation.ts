...
export const relocation: PostInterface = {
  ...
  description: "Part one of the tail about our relocation from Kyiv to Munich process. Or how to deal with stress of moving.",
  preview: [preview],
  full: [
    preview,
    p([
    ...
    p(
      'Sometimes I woke up and thought, "Shit. We are doing it". Then I got overwhelmed with the count of things I should do. To deal with that, I open my to-do list. And after a while, I am thinking, "Shit. We are doing it". But with a smile. Highly recommend.'
    ),
    p(
