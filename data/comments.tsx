...
const CommentsFull: React.FC = () => {
  return (
    <>
      ...
      <p>Second, go to the <a
        href="https://disqus.com/profile/signup/intent/">https://disqus.com/profile/signup/intent/</a> and press "I want
        to install Disqus on my site", fill-up the form, and remember the short name (it will be useful later).</p>
      <p>Third, install the <a href="https://www.npmjs.com/package/disqus-react">disqus-react</a> package from npm. If
        you are a Typescript user, this package already has typings.</p>
      <Code language={"bash"}>{`npm install disqus-react`}</Code>
      <p>And use it like this:</p>
      <Code language="jsx">
        {code}
      </Code>
      <p>You can find a usage example here: <a
        href="https://github.com/Lurk/barhamon/blob/master/components/comments.tsx">comments.tsx</a></p>
    </>
  )
}
