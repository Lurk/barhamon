...
export const rtw_trip: PostInterface = {
  ...
  preview: [p([
    ...
    a({ url: "https://www.longwayround.com/long-way-round", text: '"Long way round"' }),
    " a year ago."
  ])],
  full: [
    p([
    ...
    ul({
      content: [
        li([
          ...
          a({ url: "https://www.facebook.com/annefrancedautheville", text: "Anne-France Dautheville" }),
        ...
        li([
          ...
          a({ url: "https://en.wikipedia.org/wiki/Carl_Stearns_Clancy", text: "Carl Stearns Clancy" }),
        ...
        li([
          a({ url: "https://www.longwayround.com/", text: "Ewan McGregor and Charley Boorman" }),
          " whos journey inspired a lot of people, included me. Also, they do a new show right now - ",
          a({ url: "https://www.youtube.com/watch?v=611fw81BN98&ab_channel=AppleTV", text: "Long way up" }),
          createImageGallery(fourthSlider)
        ]),
        li([
            a({ url: "https://www.youtube.com/channel/UCYf4z6G9EqeJeOHnBu7l-mQ", text: "Sjaak Lucassen" }),
