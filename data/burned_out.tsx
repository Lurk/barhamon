...
const BurnedOutFull: React.FC = () => {
  return (
    <>
      ...
      <p>Because it was a slow process, I did not notice it right away. But when I did, I spoke with my wife and described everything about how I feel. Together we decided that it is time to go to the psychiatrist. And that was the right decision at the right time.</p>
      <p>My options were to keep going and take medications or quit and rest. So, for the first time since 17, I am unemployed. For a while, I do everything that makes me happy (that will be another post).</p>
